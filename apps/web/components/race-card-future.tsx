...
export function RaceCardFuture({ race, onTacticClick, isInProgress }: Props) {
  ...
  return (
    <div className="rounded-[var(--radius-compound)] border border-[var(--border-default)] bg-[var(--bg-app)] px-3.5 py-3 flex items-center justify-between">
      ...
      {showTacticButton ? (
        <button
          ...
          className="inline-flex h-7 w-7 items-center justify-center rounded-full border border-[var(--accent-default)]/30 bg-[var(--badge-bg)] text-[var(--accent-default)] transition-colors disabled:opacity-30 disabled:cursor-not-allowed hover:enabled:bg-[var(--badge-bg-hover)]"
