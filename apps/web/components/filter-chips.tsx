  ...
  return (
    <div className="flex gap-2 overflow-x-auto scrollbar-none">
      {options.map((option, i) => {
        ...
        let className =
          "shrink-0 cursor-pointer rounded-md border px-3.5 py-1.5 text-[length:var(--type-caption)] font-medium transition-all duration-150 whitespace-nowrap outline-none ";
