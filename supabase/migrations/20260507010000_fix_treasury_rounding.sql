-- 20260507010000_fix_treasury_rounding.sql
-- Round the average treasury to the nearest 100 on late join.
-- Bids increment by 100€, so a non-rounded treasury (e.g. 78 293€) is incoherent.
