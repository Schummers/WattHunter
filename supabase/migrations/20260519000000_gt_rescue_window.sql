...
BEGIN
  ...
  SELECT gs.team_id, gs.rider_id, gs.phase_id, gs.gt_year
  ...
  -- Retroactively forfeit XP (grant_xp is service_role-callable, callable from SECURITY DEFINER as postgres)
