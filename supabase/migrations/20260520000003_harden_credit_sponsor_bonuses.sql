-- Harden credit_sponsor_bonuses RPC:
-- 1. REVOKE PUBLIC access (was callable by any authenticated user)
-- 2. Add input validation (skip NULL/zero/negative amounts)
-- 3. Use bigint for v_total to prevent overflow
