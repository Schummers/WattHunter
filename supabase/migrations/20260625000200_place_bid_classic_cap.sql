-- Classic League Mode: cap classic-mode teams at 8 contracts in place_bid.
-- Verbatim copy of place_bid from 20260602110100 + a classic slot-cap branch.
-- Manager-mode behavior is unchanged.
...
BEGIN
  ...
  IF v_existing_bid_id IS NULL THEN
    ...
    -- Classic mode: fixed squad size of 8 regardless of level.
