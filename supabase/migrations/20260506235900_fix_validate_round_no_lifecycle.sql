-- FINAL FIX: validate_round must NOT manage auction lifecycle.
-- Keeps the improved budget error message from 20260506164031.
-- Removes steps 11-12 (close current + open next) permanently.
-- Auction closing is exclusively the Python resolve pipeline's job.
...
BEGIN
  ...
  -- No steps 11-12. Auction lifecycle is managed by the resolve pipeline only.
