-- supabase/migrations/20260508010300_place_tactic_rpc.sql
...
COMMENT ON FUNCTION place_tactic IS
  'Validate + insert a GT tactic activation. SECURITY DEFINER. Authenticated team owner only. Enforces same-league-only Nemesis target, ≥-attacker-XP eligibility, GT-phase-bound stage_slug, and forwards CHECK + usage-limit trigger errors.';
