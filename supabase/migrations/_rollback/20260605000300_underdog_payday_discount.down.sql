-- Rollback for 20260605000300_underdog_payday_discount.sql
-- Re-applies the body from 20260518000003_confirm_phase_setup_remove_late_joiner.sql
-- (the pre-discount version, which is the base this migration was built on).
