...
users ←──── league_members ────→ leagues
  ...
  └── teams ───────┘                  │
       ...
       ├── rider_xp_daily              (avec role_mult, gt_classif_bonus, gt_distance_bonus NUMERIC(5,1) — stage-hunter breakaway additive bonus, Spec A A3 ; assist_bonus NUMERIC(4,1) — domestique assists réel-équipier, refonte barème rank-based 2026-07)
