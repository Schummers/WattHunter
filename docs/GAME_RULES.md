...
```
Monthly salary = max(5,000, floor(PCS_points_1yr × 2,700 / 12 / 1,000) × 1,000)
Floor: 5,000 EUR/month | Rounded down to nearest 1,000 | No cap
```

**Examples:**
- 114 pts PCS (#600) → 308K/yr → **25,000 EUR/month**
- 400 pts PCS (#100) → 1.08M/yr → **90,000 EUR/month**
- 2,216 pts PCS (#5) → 5.98M/yr → **498,000 EUR/month**

> The multiplier was raised 2,000 → 2,500 (2026-06-30) then 2,500 → 2,700
> (2026-08-19, ahead of the Vuelta phase) to keep the flat 2M classic budget
> scarce enough. Source of truth: `calculate_monthly_salary` in
> `services/pcs-sync/sync.py`.
...
| Monthly salary | max(5,000, floor(PCS_pts × 2,700 / 12 / 1,000) × 1,000) |
