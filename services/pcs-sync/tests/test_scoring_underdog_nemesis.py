...
def _mock(*, tactics: list[dict], pcs_rank: int = 200):
    """Underdog rider (role=underdog, pcs_rank → ×2.0), 100 pts on a p4 GT stage."""
    return make_supabase(
        ...
        # 6. gt_role_assignments — underdog role
        [{"team_id": TEAM_ID, "rider_id": RIDER_ID, "role": "underdog",
